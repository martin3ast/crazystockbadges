...
This module integrates the pyGAD library to optimize the parameters for generating
3D printable badges based on stock market data.
...
Version 2.0 - Martin East - Tidy code, reduce complexity - 14 Apr 2025.
...
def fitness_function(ga_instance, solution, solution_idx):
    ...
    Returns:
        float: The fitness value to be maximised
    """
