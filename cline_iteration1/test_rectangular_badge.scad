...
difference() {
	union() {
		cube(center = false, size = [100, 60, 3]);
		union() {
			translate(v = [0.0000000000, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 12.986204537140186]);
			}
			translate(v = [4.3478260870, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 10.858750813041151]);
			}
			translate(v = [8.6956521739, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 11.969110069021792]);
			}
			translate(v = [13.0434782609, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 12.117738734673768]);
			}
			translate(v = [17.3913043478, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 11.73596366350858]);
			}
			translate(v = [21.7391304348, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 12.479115885564132]);
			}
			translate(v = [26.0869565217, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 12.146883702949589]);
			}
			translate(v = [30.4347826087, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 13.36215417216846]);
			}
			translate(v = [34.7826086957, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 14.079074144016632]);
			}
			translate(v = [39.1304347826, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 14.959199712552525]);
			}
			translate(v = [43.4782608696, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 14.312220549529846]);
			}
			translate(v = [47.8260869565, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 14.988344680828348]);
			}
			translate(v = [52.1739130435, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 13.254321347066153]);
			}
			translate(v = [56.5217391304, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 14.4870814653892]);
			}
			translate(v = [60.8695652174, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 14.795998562762627]);
			}
			translate(v = [65.2173913043, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 15.0]);
			}
			translate(v = [69.5652173913, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 8.967360659421583]);
			}
			translate(v = [73.9130434783, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 4.65125500350119]);
			}
			translate(v = [78.2608695652, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 2.634546822572928]);
			}
			translate(v = [82.6086956522, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 0.0]);
			}
			translate(v = [86.9565217391, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 7.702547301652045]);
			}
			translate(v = [91.3043478261, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 5.245774113006939]);
			}
			translate(v = [95.6521739130, 6.0000000000, 3]) {
				cube(size = [3.9130434783, 48.0000000000, 7.498541417516872]);
			}
		}
	}
	translate(v = [50.0000000000, 30.0000000000, -2]) {
